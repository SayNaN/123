...
QT_MOC_LITERAL(1, 11, 10), // "processRes"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 6) // "nIndex"

    },
    "MyGLWidget\0processRes\0\0nIndex"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->processRes((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
void *MyGLWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions_1_1"))
        return static_cast< QOpenGLFunctions_1_1*>(const_cast< MyGLWidget*>(this));
