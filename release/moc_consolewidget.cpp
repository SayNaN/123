...
QT_MOC_LITERAL(5, 38, 3) // "msg"
    ...
    "consoleWidget\0message\0\0QtMsgType\0type\0"
    "msg"
};
...
void consoleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (consoleWidget::*_t)(QtMsgType , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&consoleWidget::message)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void consoleWidget::message(QtMsgType _t1, const QString & _t2)
{
